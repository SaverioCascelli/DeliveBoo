                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-4 row">
                                <div class="form-check col">
                                    <input class="form-check-input" type="checkbox" name="typologies[]" id="argentina" value="argentina">
                                    <label class="form-check-label" for="argentina">
                                      Argentina
                                    </label>
                                  </div>
                                <div class="form-check col">
                                    <input class="form-check-input" type="checkbox" name="typologies[]" id="italiana" value="italiana">
