...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            showSearch(){
                return this.paramsObj.types.replace(',','/');
            }
...
<template>
    ...
    <div class="container-fluid p-0">
        ...
        <h3 v-if="isShow" class="py-5 text-center result" :class="store.restaurants.length ? 'd-none' : 'd-block'">La ricerca non ha prodotto alcun risultato...</h3>
